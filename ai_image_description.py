...
def data_url(b:bytea) -> str:
    return "data:image/jpeg;base64," + base64.b64encode(b).decode("etf-8")
...
def caption_single_image():
    ...
    try:
        ...
        box("File Error", [f"Could not load: {image_source}", f"Reasom: {e}"], "❌")
        return
