...
mp_drawing = mp.solutions = mp.solutions.drawing_utils
...
while cap.isOpened():
  ...
  p_time = time.time()
  cv2.putText(img, f"DPS: {int(fps)} | Hand: {handedness} | Gesture: {gesture}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 0, 0), 2)
