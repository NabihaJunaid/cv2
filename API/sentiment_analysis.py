...
HEAD= {"Autorization": f"Bearer {HF_API_KEY}"}
TH=0.72
...
def hf(q1, q2):
    r=requests.post(API, header=HEAD, json={"inputs":{"source_sentence":q1, "sentences": [q2]}}, timeout=30)
...
def show_flow(q1, q2):
    ...
    conn = {"a", "an", "the", "to", "of", "in", "on", "is", "am", "are",
            "do", "did", "does", "my", "me", "it"}
